...
spi = pre(17:end,4:end);
 ...
 bs1 = [-0.1097 0.7938 -0.4695 0.4033]'; % valores constantes para la ecuación 1 componente
 bs2 = [0.5857 -0.7325 -0.4927]';        % valores constantes para la ecuación 2 componente
 bs3 = [0.1016 -0.4654 -0.2924]';        % valores constantes para la ecuación 3 componente
...
subplot(3,1,1)
    ...
    ylim([-4 4])
    grid on
    title('STPW: Pronóstico PC1 - SPI para EFM Sierra Sur (ic Ene)','FontSize',19,'FontWeight','bold')
...
subplot(3,1,2)
    ...
    ylim([-4 4])
    grid on
    title('STPW: Pronóstico PC2 - SPI para EFM Sierra Sur (ic Ene)','FontSize',19,'FontWeight','bold')
...
subplot(3,1,3)
    ...
    ylim([-4 4])
    grid on
    title('STPW: Pronóstico PC3 - SPI para EFM Sierra Sur (ic Ene)','FontSize',19,'FontWeight','bold')
...
% Puntos agregados para uniformizar la distribución de la componente
...
%% Pronóstico por punto de estación 
